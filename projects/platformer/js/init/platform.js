(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(100, 580, .5, .5);
        platform.create(300, 450, .5, .5);
        platform.create(400, 340, .5, .5);
        platform.create(500, 220, .5, .5);
        platform.create(650, 100, .5, .5);
        platform.create(750, 0, .5, .5);
